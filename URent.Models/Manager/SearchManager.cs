...
namespace URent.Models.Manager
{
    ...
    public class SearchManager : ISearch
    {
        ...
        public IList<Model.Order> SearchAvailableCategories(DateTime dateDeparture, DateTime dateReturn, int categoryId = 0)
        {

            //List of categories available
            var listCategoryAvailable = GetCategoryAvailable(dateDeparture, dateReturn, categoryId);
        ...
        /// <param name="categoryId">(Optionnel) ID de la catégorie / Si pas envoyé ou zero, la fonction cherche pour toutes les catégories</param>
        /// <returns>Retourne une liste des catégories disponibles</returns>
        public IList<Model.Category> GetCategoryAvailable(DateTime dateDeparture, DateTime dateReturn, int categoryId)
        {
        ...
        public int GetCarAvailable(DateTime dateDeparture, DateTime dateReturn, int categoryId)
        {
            var carId = 0;
            var objRes = new ReservationManager();
            var objCar = new CarManager();
        ...
        public bool CheckAvailableCategory(DateTime dateDeparture, DateTime dateReturn, int categoryId)
        {
            var list = SearchAvailableCategories(dateDeparture, dateReturn, categoryId);
            return list.Any();
        }
